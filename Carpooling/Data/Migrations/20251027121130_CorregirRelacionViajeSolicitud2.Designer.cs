...
namespace Data.Migrations
{
    ...
    [Migration("20251027121130_CorregirRelacionViajeSolicitud2")]
    partial class CorregirRelacionViajeSolicitud2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Calificacion", b =>
                {
                    ...
                    b.Property<int>("IdCalificado")
                        .HasColumnType("int");

                    b.Property<int>("IdCalificador")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RolCalificado")
                        .HasColumnType("int");

                    b.HasKey("IdCalificacion");

                    b.HasIndex("IdCalificado");

                    b.HasIndex("IdCalificador");
            ...
            modelBuilder.Entity("Domain.Model.Calificacion", b =>
                {
                    b.HasOne("Domain.Model.Usuario", "Calificado")
                        .WithMany("CalificacionesRecibidas")
                        .HasForeignKey("IdCalificado")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Model.Usuario", "Calificador")
                        .WithMany("CalificacionesDadas")
                        .HasForeignKey("IdCalificador")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
